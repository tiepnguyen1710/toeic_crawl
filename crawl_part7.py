...
# Mở và đọc file HTML
with open('text/2024_6/part7.txt', 'r', encoding='utf-8') as file:
...
for i, (question_wrapper, image_div, transcript_div) in enumerate(zip(question_wrappers, images, transcripts)):
    #print(f"i = {i}, audio_div = {audio_div}, image_div = {image_div}, transcript_div = {transcript_div}")
    # Khởi tạo đối tượng cho từng phần tử
    obj = {'image': [], 'transcript': '', 'questionData' : []}
    ...
    arr = [2, 2, 2, 3, 3, 2, 3, 4, 4, 4, 5, 5, 5, 5, 5]
